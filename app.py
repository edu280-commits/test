...
# ── 3‑3. 서술형 문제 3 표시 ──
QUESTION_3 = """
지구의 공전으로 나타나는 천체의 현상을 3가지 설명하시오.
"""
...
# ── 1. 문항별 채점 기준 (교사가 수정) ──
GRADING_GUIDELINES = {
    1: "지구의 자전으로 인해 별의 일주 운동이 나타남을 설명한다.",
    2: "지구의 공전으로 별의 연주 운동이 나타남을 설명한다.",
    3: "지구의 공전으로 일년에 한번 변하는 태양이 별자리 사이를 움직인다, 계절별 별자리가 변한다"
}
